...
// Сделайте тоже самое с классом Manager (для него надо сделать свою таблицу)
        ...
        EntityClassMetaData entityClassMetaDataManager = (EntityClassMetaData) new EntityClassMetaDataImpl(Manager.class);
    ...
    private static void flywayMigrations(DataSource dataSource) {
        ...
        var flyway = Flyway.configure()
                ...
                .locations("classpath:C:\\Users\\Honor\\Desktop\\hw09-jdbc\\src\\main\\resources\\db.migration")
                .load();
        flyway.migrate();
