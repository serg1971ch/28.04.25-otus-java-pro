...
public class EntitySQLMetaDataImpl<T> implements EntitySQLMetaData {
    ...
    private final ru.otus.jdbc.mapper.EntityClassMetaData<T> entityClassMetaData;

    public EntitySQLMetaDataImpl(ru.otus.jdbc.mapper.EntityClassMetaData<T> entityClassMetaData) {
